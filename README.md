...
### Logo | Favicon
Logo was generated by AI. It represents a developer in front of a computer surrounded  by stylized tech elements, in a flat vector style with a colour palette of blues, dark yellow and white, set against a dark background. The developer is half man, half woman to represent all genres of programming developers.

## Env
process.env.DEBUG
process.env.JWT_SECRET
process.env.JWT_BAKEND
