...
describe("Mongoose Models Mocking with Bun", () => {
  describe("User Model", () => {
    ...
    it("should find a user by name", async () => {
      ...
      User.findOne = vi.fn().mockResolvedValue(userData);
  ...
  describe("Message Model", () => {
    it("should create a new message successfully", async () => {
      ...
      message.save = vi.fn().mockResolvedValue(message);
    ...
    it("should update a message as replied", async () => {
      ...
      Message.findById = vi.fn().mockResolvedValue({
        ...messageData,
        save: vi.fn().mockResolvedValue({ ...messageData, replied: true }),
      });
  ...
  describe("Reply Model", () => {
    it("should create a new reply successfully", async () => {
      ...
      reply.save = vi.fn().mockResolvedValue(reply);
  ...
  describe("Post Model", () => {
    it("should create a new post successfully", async () => {
      ...
      post.save = vi.fn().mockResolvedValue(post);
    ...
    it("should find posts by tag", async () => {
      ...
      Post.find = vi.fn().mockResolvedValue(posts);
